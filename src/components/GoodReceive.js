...
function GoodReceivedForm({ onItemsUpdate }) {
  ...
  useEffect(() => {
    const fetchAdminItems = () => {
      fetch('https://3ed2-211-25-11-204.ngrok-free.app/admin-dashboard/items', {
        method: 'GET',
        credentials: 'include',
        headers: {
  ...
  const fetchFileHistory = () => {
    fetch('https://3ed2-211-25-11-204.ngrok-free.app/api/fileHistory', {
      method: 'GET',
      credentials: 'include',
      headers: { 
        'Content-Type': 'application/json',
  ...
  const updateAdminInventory = () => {
    ...
    fetch('https://3ed2-211-25-11-204.ngrok-free.app/goodsreceived/update-inventory', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'ngrok-skip-browser-warning': '1'
  ...
  const uploadFiles = async () => {
    ...
    try {
      const response = await fetch('https://3ed2-211-25-11-204.ngrok-free.app/api/uploadFiles', {
        method: 'POST',
        credentials: 'include',
  ...
  const previewFile = async (fileId) => {
    try {
      const res = await fetch(`https://3ed2-211-25-11-204.ngrok-free.app/api/filePreview/${fileId}`, {
        method: 'GET',
        credentials: 'include',
        headers: { 
          'Content-Type': 'application/json',
  ...
  const deleteFile = async (fileId) => {
    ...
    try {
      const res = await fetch(`https://3ed2-211-25-11-204.ngrok-free.app/api/deleteFile/${fileId}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: { 
          'Content-Type': 'application/json',
  ...
  const saveFileEdits = async () => {
    ...
    try {
      const res = await fetch(`https://3ed2-211-25-11-204.ngrok-free.app/api/updateFile/${currentFile.id}`, {
        method: 'PUT',
        headers: { 
          'Content-Type': 'application/json',
          'ngrok-skip-browser-warning': '1'
  ...
  const saveNewItems = async () => {
    ...
    for (const item of items) {
      if (!item.value && item.label.trim() !== '' && item.addToAdmin) {
        try {
          await fetch('https://3ed2-211-25-11-204.ngrok-free.app/admin-dashboard/add-item', {
            method: 'POST',
