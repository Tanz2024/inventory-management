...
const ManageSites = ({ onClose, onUpdate }) => {
  ...
  const handleAddSite = async () => {
    ...
    try {
      const resp = await fetch('https://e89d-211-25-11-204.ngrok-free.app/dropdown-options/sites', {
        method: 'POST',
        headers: commonHeaders,
        credentials: 'include',
  ...
  const handleRenameSiteLocal = async (oldName) => {
    ...
    try {
      const resp = await fetch('https://e89d-211-25-11-204.ngrok-free.app/dropdown-options/sites/rename', {
        method: 'PATCH',
        headers: commonHeaders,
        credentials: 'include',
